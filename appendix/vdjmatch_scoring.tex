...
already set by the radius. The remaining first-order lever is the \emph{V-gene} dimension (cross-V
comparisons and V-similarity grouping), where germline-flank differences are common and this central
weighting should matter most.
...
held-out epitopes. These extensions, and the full benchmark against existing tools, are ongoing work.
