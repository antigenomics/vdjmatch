...
$VDJDB -S human -R TRB --search-scope 3,1,3 -v-match -j-match sergey_anatolyevich.gz test
...
$VDJDB -S human -R TRB --search-scope 3,0,3 -v-match -j-match --scoring-vdjmatch sergey_anatolyevich.gz test
...
$VDJDB -S human -R TRB empty.txt test_empty
...
$VDJDB -S human -R TRB no_found.txt test_empty2
