 ...
 *
 */
class SubstringSetTextFilter extends TextFilter {
     ...
     */
    SubstringSetTextFilter(String columnId, String value, boolean negative) {
    ...
    protected boolean passInner(Entry entry) {
        ...
        if (checkAutoPass(otherSplitValue))
            return true
        otherSplitValue.any { entryVal -> splitValue.any { queryVal -> entryVal.toLowerCase().contains(queryVal) } }
    }
